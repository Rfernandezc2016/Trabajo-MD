...
(table(datos.setas_train$Letalidad,datos.setas_train$Fijacion_L)[,1]/sum(datos.setas_train$Fijacion_L=="a"))*100
```
...
```{r proporcion venenosas o comestibles si están adjuntas,echo=TRUE}
(table(datos.setas_train$Letalidad,datos.setas_train$Espacio_L)[,2]/sum(datos.setas_train$Espacio_L=="w"))*100
```
