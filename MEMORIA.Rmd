...
setas_50=distancia_dice[,k50$medoid]
```
...
arbol=rpart(Venenosas~., data =setas_train[k50$medoid,],method="class")
summary(arbol)
...
#Error de predicción
table(pred=predict(arbol,type="class"), obs=setas_train[k50$medoid,]$Venenosas)
n=dim(setas_train[k50$medoid,])[1]
error=100 *(sum(predict(arbol, type = "class")!=setas_train[k50$medoid,]$Venenosas)/n)
error
```
