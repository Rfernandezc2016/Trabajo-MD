...
barplot(table(datos.setas_train$Letalidad,datos.setas_train$Forma_S),main="Letalidad vs Forma del sombrero",xlab="Forma_S",ylab="Número de setas",names.arg=c("Campana", "Cónica", "Plana", "Nudosa", "Hundida", "Convexa"),col=c("blue","magenta"))
...
barplot(table(datos.setas_train$Letalidad,datos.setas_train$Cuticula),main="Letalidad vs Cuticula",xlab="Forma_S",ylab="Número de setas",names.arg=c("Fibroso", "Con surcos", "Lisa", "Escamosa"),col=c("blue","magenta"))
...
barplot(table(datos.setas_train$Letalidad,datos.setas_train$Color_S),main="Letalidad vs Color del sombrero",xlab="Forma_S",ylab="Número de setas",names.arg=c("Ante", "Canela", "Rojo", "Gris","Marrón","Rosa","Verde","Morado","Blanco","Amarillo"),col=c("blue","magenta"))
