...
arbol=rpart(Venenosas~., data=setas50_train.respuesta,method="class")
summary(arbol)
...
n=dim(setas50_train.respuesta)[1]
error=100 *(sum(predict(arbol, type = "class")!=setas50_train.respuesta$Venenosas)/n)
error
```
...
# Predecimos
prediccion_svm.parametros=predict(setas.svm_parametros, svm_x)

# Calculamos la matriz de confusión
table(prediccion_svm.parametros, svm_y)
