...
#Test de independencia:
chisq.test(table(datos.setas_train$Letalidad,datos.setas_train$Cuticula))
```


### Color del sombrero (Color_S)

```{r color del sombrero,echo=TRUE}
...
```{r proporcion venenosas o comestibles si están adjuntas,echo=TRUE}
#Proporción según fijacion sea adjunto
prop.table(table(datos.setas_train$Letalidad,datos.setas_train$Fijacion_L)[,1])*100

#Proporción según fijacion sea libre
prop.table(table(datos.setas_train$Letalidad,datos.setas_train$Fijacion_L)[,2])*100
```
...
prop.table(table(datos.setas_train$Letalidad,datos.setas_train$Espacio_L)[,1])*100

#Proporción según espacio sea atestado
prop.table(table(datos.setas_train$Letalidad,datos.setas_train$Espacio_L)[,2])*100
```
...
prop.table(table(datos.setas_train$Letalidad,datos.setas_train$Tamaño_L)[,1])*100

#Proporción según tamaño sea estrecho
prop.table(table(datos.setas_train$Letalidad,datos.setas_train$Tamaño_L)[,2])*100
```


### Color de las láminas (Color_L)

```{r color laminas,echo=TRUE}
...
prop.table(table(datos.setas_train$Letalidad,datos.setas_train$Forma_T)[,1])*100

#Proporción según forma sea afilado
prop.table(table(datos.setas_train$Letalidad,datos.setas_train$Forma_T)[,2])*100
```


### Tallo-Raíz (Tallo_raiz)

```{r tallo raiz,echo=TRUE}
...
#Test de independencia:
chisq.test(table(datos.setas_train$Letalidad,datos.setas_train$Color_T1))
```


### Color del tallo por debajo del anillo (Color_T2)

```{r color t2,echo=TRUE}
...
#Test de independencia:
chisq.test(table(datos.setas_train$Letalidad,datos.setas_train$Color_V))
```
