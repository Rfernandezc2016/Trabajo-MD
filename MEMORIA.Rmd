...
Los resultados son bastantes parecidos cuando cogemos una cantidad de medoides entre 10 y 20. Por ello, nos quedaremos con 15 medoides, valor elegido arbitrariamente.
...
```{r knn,echo=TRUE}
trainTest=rbind(setas_train[k15$medoid,],setas_test)
distancia_trainTest=distance(trainTest,method="dice")
distancia_trainTest=distancia_trainTest[1:15,-c(1:15)]
dim(distancia_trainTest)



#Buscamos los vecinos más cercanos
prediccion_knn=knn(setas_train[k15$medoid,],setas_test,cl=setas_train$Venenosas[k15$medoid],k=1)
