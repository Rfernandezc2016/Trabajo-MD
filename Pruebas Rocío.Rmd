...
for(i in 1:dim(datos.setas)[1]){
  if(datos.setas[i,1]=="e"){
    ...
    no_venenosas=no_venenosas+1
  }
  if(datos.setas[i,1]=="p"){
    setas=rbind(setas,c(1))
    venenosas=venenosas+1
  }
  
}
setas=setas[-1,]

barplot(c(venenosas,no_venenosas),main = "Setas", ylab = "Número de setas",col =
c("blue","magenta") )
legend(x = "bottomleft", legend = c("Venenosas","No venenosas"), fill = c("blue", "magenta"), 
title = "Letalidad")
```
...
barplot(c(campana,conica,convexa,plana,nudosa,hundida),main = "Setas", ylab = "Número de setas",col =
c("blue","magenta","green","yellow","red","orange") )
legend(x = "topleft", legend = c("Camapana","Cónica","Convexa","Plana","Nudosa","Hundida"), fill = c("blue", "magenta","green","yellow","red","orange"), 
title = "Forma del sombrero")
```
...
barplot(c(fibroso,surcos,escamoso,liso),main = "Setas", ylab = "Número de setas",col =
c("blue","magenta","green","yellow") )
legend(x = "bottomright", legend = c("Fibroso","Con surcos","Escamoso","Liso"), fill = c("blue", "magenta","green","yellow"),
title = "Superficie del sombrero")
```
