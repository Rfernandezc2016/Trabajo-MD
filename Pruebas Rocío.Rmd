...
pca.respuesta=cbind(setas_train[,1],nuevos.datos.pca)
pca.venenosas=which(pca.respuesta[,1]==1)
pca.novenenosas=which(pca.respuesta[,1]==0)

plot(nuevos.datos.pca)
points(nuevos.datos.pca[pca.venenosas,],col="aquamarine")
points(nuevos.datos.pca[pca.novenenosas,],col="purple")
